...
<head>
  ...
  <title>Review IPCR Submissions | CSU-Piat</title>
...
<main class="main-content" id="mainContent">
  <div class="page-header d-flex justify-content-between align-items-start flex-wrap gap-2">
    <div>
      <h2><i class="fa-solid fa-clipboard-check me-2 text-primary"></i>Review IPCR Submissions</h2>
      <p>Review and approve/disapprove IPCR forms from your department.</p>
    </div>
  ...
  <div class="table-wrapper">
    <div class="table-header">
      <h6><i class="fa-solid fa-list me-2"></i>IPCR Submissions</h6>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fa-solid fa-clipboard-check me-2"></i>Review IPCR Form</h5>
      ...
      <div class="modal-footer">
        <div class="me-auto d-flex gap-2 align-items-center">
          <label class="form-label mb-0">Final Status:</label>
        ...
        <button class="btn btn-primary btn-sm" id="saveReviewBtn" onclick="saveReview()">
          <i class="fa-solid fa-save me-1"></i>Save Review
        </button>
      </div>
    </div>
  </div>
...
<script>
  initLayout('admin', 'review-ipcr', [{ label: 'Review IPCR' }]);
  ...
  async function loadForms() {
    ...
    const url = API_BASE + 'ipcr/list.php' + (status ? '?status=' + status : '');
    ...
    if (forms.length === 0) {
      tbody.innerHTML = `<tr><td colspan="8" class="text-center py-4 text-muted"><i class="fa-solid fa-inbox me-2"></i>No IPCR submissions found.</td></tr>`;
      return;
    }
    tbody.innerHTML = forms.map((f, i) => {
      ...
      return `<tr>
        <td>${i+1}</td>
        <td style="font-size:0.85rem"><strong>${f.user_name}</strong></td>
        <td style="font-size:0.82rem">${f.position || '-'}</td>
  ...
  async function saveReview() {
    ...
    try {
      ...
      btn.disabled = false;
      btn.innerHTML = '<i class="fa-solid fa-save me-1"></i>Save Review';
    }
  }
