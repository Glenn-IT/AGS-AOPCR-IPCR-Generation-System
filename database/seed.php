...
function runSeed(PDO $db): array {
    ...
    // ----------------------------------------------------------
    $timelines = [
        [1, '2025', 'January to June', '2025-01-01', '2025-06-30', '2025-07-15', 'closed'],
        [2, '2025', 'July to December', '2025-07-01', '2025-12-31', '2026-01-15', 'closed'],
        [3, '2026', 'January to June', '2026-01-01', '2026-06-30', '2026-07-15', 'open'],
        [4, '2026', 'July to December', '2026-07-01', '2026-12-31', '2027-01-15', 'closed'],
    ];
