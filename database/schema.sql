...
CREATE TABLE IF NOT EXISTS ipcr_items (
  ...
  q_rating        DECIMAL(3,2) DEFAULT NULL CHECK (q_rating BETWEEN 1 AND 5),
  e_rating        DECIMAL(3,2) DEFAULT NULL CHECK (e_rating BETWEEN 1 AND 5),
  t_rating        DECIMAL(3,2) DEFAULT NULL CHECK (t_rating BETWEEN 1 AND 5),
